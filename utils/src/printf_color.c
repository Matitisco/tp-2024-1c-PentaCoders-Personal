...
void printf_red(const char *format, ...) {
    va_list args;
    va_start(args, format);
    printf_color("\033[31m", format, args);
    va_end(args);
}
...
void printf_blue(const char *format, ...) {
    va_list args;
    va_start(args, format);
    printf_color("\033[34m", format, args);
    va_end(args);
}
...
void printf_yellow(const char *format, ...) {
    va_list args;
    va_start(args, format);
    printf_color("\033[93m", format, args);
    va_end(args);
}
...
void printf_orange(const char *format, ...) {
    va_list args;
    va_start(args, format);
    printf_color("\033[38;2;255;165;0m", format, args);
    va_end(args);
}
...
void printf_green(const char *format, ...) {
    va_list args;
    va_start(args, format);
    printf_color("\033[32m", format, args);
    va_end(args);
}
...
void printf_purple(const char *format, ...) {
    va_list args;
    va_start(args, format);
    printf_color("\033[35m", format, args);
    va_end(args);
}